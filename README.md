...
以系统扫描SSRF漏洞为例，有如下漏洞代码：

![QQ_1768986520785](./images/QQ_1768986520785.png)

后端将其解析处理为AST树，部分预览如下：
![QQ_1768986648906](./images/QQ_1768986648906.png)

系统根据AST树将其处理为中间表示IR（伪三地址码）并根据跳转、分支逻辑划分为多个basic block（图中的B0、B1...）：
![QQ_1768986732625](./images/QQ_1768986732625.png)

系统根据IR处理划分的basic block绘制控制流图CFG：
![QQ_1768986906891](./images/QQ_1768986906891.png)

系统根据预定规则识别到URL.Query为source点，http.Get为sink点，并根据控制流图进行数据流分析，如果source点到sink点之间的变量传输可达，则判定为存在漏洞，在block上高亮处理：
![QQ_1768987062409](./images/QQ_1768987062409.png)

最后将污点变量传递的路径映射到源代码并显示：
![QQ_1768987376561](./images/QQ_1768987376561.png)
